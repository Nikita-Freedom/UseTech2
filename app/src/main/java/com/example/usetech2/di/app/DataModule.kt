...
import com.example.usetech2.data.SuperHeroRepositoryImpl
...
object DataModule {
    ...
    @JvmStatic
    @Provides
    fun provideRepository(api: SuperHeroApi): SuperHeroRepository {
    ...
    @JvmStatic
    @Provides
    fun provideForSquareApi(retrofit: Retrofit): SuperHeroApi =
        ...
        val builder = OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                val url = request.url.newBuilder()
                    //.addQueryParameter("key", SuperHeroApi.API_KEY)
                    .build()
